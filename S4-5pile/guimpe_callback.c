...
extern p_pile_img pile_future;
extern p_pile_img pile_passe;
...
void OnQuitter(GtkWidget* widget, gpointer data)
{
	...
	switch(gtk_dialog_run(GTK_DIALOG(pQuestion)))
	{
		case GTK_RESPONSE_YES:
			pile_detruire(&pile_future);
			pile_detruire(&pile_passe);
			gtk_main_quit();
			break;
